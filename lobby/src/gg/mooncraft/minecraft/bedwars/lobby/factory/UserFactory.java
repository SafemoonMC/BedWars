package gg.mooncraft.minecraft.bedwars.lobby.factory;
...
public final class UserFactory {
    ...
    public void loadUser(@NotNull Player player) {
        UserDAO.read(player.getUniqueId()).thenAccept(bedWarsUser -> {
            this.userList.add(bedWarsUser);
            BedWarsPlugin.getInstance().getLogger().info(player.getName() + "'s data has been loaded!");
        });
    }
