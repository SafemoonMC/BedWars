...
public final class ItemStackCreator {
    ...
    public static ItemStackCreator using(@NotNull ConfigurationSection configurationSection) {
        ...
        if (configurationSection.contains("material")) {
            ...
            if (material == null)
                throw new IllegalArgumentException("There is no material called " + configurationSection.getString("material"));
            ...
            throw new IllegalArgumentException("No ItemStack can be created from that ConfigurationSection!");
        ...
        if (itemStack.getItemMeta() == null) return itemStackCreator;
            ...
            return ItemMetaCreator.using(itemStackCreator, itemStack.getItemMeta(), configurationSection).stack();
    }
}