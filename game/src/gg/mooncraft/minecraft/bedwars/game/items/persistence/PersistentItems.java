...
public final class PersistentItems {
    ...
    public static <T> void set(ItemStack itemStack, PersistentDataItem<T> persistentDataItem, T value) {
    ...
    public static boolean has(ItemStack itemStack, PersistentDataItem<?> persistentDataItem) {
    ...
    public static <T> Optional<T> get(ItemStack itemStack, PersistentDataItem<T> persistentDataItem) {
