...
@Getter
@AllArgsConstructor
public class MatchBlockBreakEvent extends Event implements Cancellable {
    ...
    Constructor
     */
    public MatchBlockBreakEvent(@NotNull Player player, @NotNull Location location, @NotNull GameMatch gameMatch, @NotNull GameMatchPlayer gameMatchPlayer) {
        this.player = player;
